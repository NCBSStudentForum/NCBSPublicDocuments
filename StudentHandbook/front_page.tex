...
\begin{tikzpicture}[remember picture,overlay, scale=1
    ...
    \edef\cl{white}
    \node[text width=0.6\paperwidth] (title) at (0.45\paperwidth,1cm) { 
        \textcolor{\cl}{\fontsize{1.5cm}{2cm}\selectfont Student Handbook}
    };
    ...
    \node[] (ncbs) at (0.55\paperwidth,-0.8\paperheight) { 
        \includegraphics[height=2.5cm]{../Logos/ncbs_logo.png}
    };
    \node[] (ncbs) at (0.05\paperwidth,-0.8\paperheight) { 
        \includegraphics[height=2.5cm]{../Logos/inStem_logo.png}
    };
    
    % credit
    \node[inner sep=2pt,yshift=2mm,xshift=2cm] (credit) 
        at (current page.south west) {
            \textcolor{green}{\tiny \tt Photo credit: Venkat Srinivasan}
        };
